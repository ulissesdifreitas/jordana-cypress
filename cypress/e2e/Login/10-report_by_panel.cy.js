...
describe('Login Jordana', () => {
    ...
    it('Verifica exibição de paineis filragem por cidade', () => {
        ...
        Helper.leitura_e_contagem_testes_relatorio()
        Helper.leitura_e_contagem_resultado_nao_detectável()
        Helper.leitura_e_contagem_resultado_inconclusivo()
        Helper.leitura_e_contagem_resultado_hpv_16()
        Helper.leitura_e_contagem_resultado_hpv_18()
        Helper.leitura_e_contagem_resultado_hpv_outros()
